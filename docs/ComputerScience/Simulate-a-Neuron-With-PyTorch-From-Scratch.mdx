...
```
<p align="center"><i>Figure 2. Effectiveness vs. Dose Relationship</i></p>
### Implement a Neuron-like network with PyTorch

Assume the structure below is the neuron in the real world.

<p align="center">
  <Image img={require('../assets/computer-science/Simple-Neuron-Network-Real-World.png')} />
...
<p align="center">
  <Image img={require('../assets/computer-science/Response-Real-World.png')} style={{width: 500}} />
...
<p align="center">
  <Image img={require('../assets/computer-science/Response-Untrained.png')} style={{width: 500}}/>
...
<p align="center">
  <Image img={require('../assets/computer-science/Response-Trained.png')} style={{width: 500}}/>
